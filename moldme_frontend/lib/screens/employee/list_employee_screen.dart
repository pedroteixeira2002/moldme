...
class AllEmployeesScreen extends StatefulWidget {
  ...
  const AllEmployeesScreen({Key? key, required this.companyId}) : super(key: key);
  ...
  Future<void> fetchEmployees() async {
    try {
      ...
      final List<EmployeeDto> fetchedEmployees =
          await employeeService.listAllEmployeesFromCompany(widget.companyId);
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Expanded(
            child: AppDrawer(
              userId: widget.companyId, // Replace with actual userId
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          // Removida a opção de tocar no funcionário para editar
                        );
                      },
                    ),
                  Positioned(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(context,
                              ...
                              return AddEmployeeScreen(companyId: widget.companyId);
