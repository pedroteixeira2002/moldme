...
class ProjectService {
  ...
  Future<String> removeProject(String projectId) async {
    ...
    if (response.statusCode == 200) {
      return response.body.isNotEmpty ? json.decode(response.body) : 'Project removed successfully'; // Success message
    } else {
      throw Exception(
          response.body.isNotEmpty ? json.decode(response.body)['error'] : "Failed to remove project");
    }
  }
